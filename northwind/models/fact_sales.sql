...
(
    select
        ...
        sum(extendedpriceamount*Discount) as discountamount,
        sum(extendedpriceamount-discountamount) as soldamount
...
stg_shippers as (
    ...
    select
        o.*,
        s.companyname as shippercompanyname, od.quantityonorder, od.totalorderamount,
        ...
        case when o.shippeddatekey-o.requireddatekey<=0 then 'Y' else 'N' end as
        shippedontime
    from stg_orders o
